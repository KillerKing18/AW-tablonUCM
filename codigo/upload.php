...
<head>
	...
	<script type="text/javascript">
		...
		function inicializacion(){
			var selectorFacultad = document.getElementById('facultad');
			selectorFacultad.addEventListener('onchange', cambiaSelectorGrado());
		}
	...
	<script>
		$(document).ready(function(){
			$("#facultad").change(function(){
				$.post("procesaSelectores.php",
					{ "caso" : "grado", "facultad": "Facultad de Matemáticas" },
					function(data) {
						alert("Data: " + data);
